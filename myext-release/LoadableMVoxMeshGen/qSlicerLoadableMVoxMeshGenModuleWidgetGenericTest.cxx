...
//-----------------------------------------------------------------------------
int qSlicerLoadableMVoxMeshGenModuleWidgetGenericTest( int argc, char * argv[] )
{
  bool res = true;
  qSlicerApplication app(argc, argv);
  app.errorLogModel()->setTerminalOutputs(ctkErrorLogTerminalOutput::All);

  qSlicerLoadableMVoxMeshGenModule module(0);
  ...
  if (widget->minimumSizeHint().width() > maxMinimumSizeHintWidth)
  {
    std::cerr << "Line " << __LINE__
              << " qSlicerLoadableMVoxMeshGenModule widget has a minimum size hint width"
