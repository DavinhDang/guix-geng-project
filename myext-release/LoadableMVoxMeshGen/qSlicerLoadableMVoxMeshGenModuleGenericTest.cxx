...
//-----------------------------------------------------------------------------
int qSlicerLoadableMVoxMeshGenModuleGenericTest( int argc, char * argv[] )
{
  qSlicerApplication app(argc, argv);
  app.errorLogModel()->setTerminalOutputs(ctkErrorLogTerminalOutput::All);

  qSlicerLoadableMVoxMeshGenModule * module = new qSlicerLoadableMVoxMeshGenModule;
  module->setName("LoadableMVoxMeshGen");
  module->setObjectName(QString("%1Module").arg("LoadableMVoxMeshGen"));
  ...
  QString modulePathWithoutIntDir = QLatin1String("/home/davinh/guix-geng-project/myext-release/lib/Slicer-5.8/qt-loadable-modules");
  ...
  QString moduleFileName = "libqSlicerLoadableMVoxMeshGenModule.so";
  ...
  }
  {
    bool current = qSlicerLoadableModule::addModuleToSlicerModules(
          pythonManager, module, "LoadableMVoxMeshGen");
    bool expected = true;
    if (current != expected)
    {
  ...
  }
  {
    bool current = qSlicerLoadableModule::addModuleNameToSlicerModuleNames(
          pythonManager, "LoadableMVoxMeshGen");
    bool expected = true;
    if (current != expected)
    {
  ...
  if (module->title().isEmpty())
  {
    std::cerr << "Line " << __LINE__
              << " - qSlicerLoadableMVoxMeshGenModule::title() is empty." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "Line " << __LINE__
              << " - qSlicerLoadableMVoxMeshGenModule::categories() is empty." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "Line " << __LINE__
              << " - qSlicerLoadableMVoxMeshGenModule::index() seems invalid." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  //  {
  //  std::cerr << "Line " << __LINE__
  //            << " - qSlicerLoadableMVoxMeshGenModule::helpText() is empty." << std::endl;
  //  return EXIT_FAILURE;
  //  }
  ...
  {
    std::cerr << "Line " << __LINE__
              << " - qSlicerLoadableMVoxMeshGenModule::acknowledgementText() is empty." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "Line " << __LINE__
              << " - qSlicerLoadableMVoxMeshGenModule::contributors() is empty." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "Line " << __LINE__
              << " - qSlicerLoadableMVoxMeshGenModule::initialize() failed." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (!moduleRepresentation && !module->isHidden())
  {
    ...
    std::cerr << "Line " << __LINE__
              << " qSlicerLoadableMVoxMeshGenModule has no widget representation."
  ...
  {
    std::cerr << "Line " << __LINE__
              << " - qSlicerLoadableMVoxMeshGenModule::setMRMLScene() failed." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "Line " << __LINE__
              << " - qSlicerLoadableMVoxMeshGenModule::setMRMLScene() failed to pass"
